...
class MilkFeed:
    ...
    def __init__(self, volume: float, unit: vol.VolumeUnit, caregiver: Caregiver, datetime: datetime.datetime):
        self.volume = volume
        self.unit = unit
    ...
    @classmethod
    def from_narababy_bottle_feed_row(cls, narababy_row: NarababyBottleFeedRow) -> MilkFeed:
        return cls(
